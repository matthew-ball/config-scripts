...
(defcustom user-scratch-directory (format "%s/Public/scratch/" user-home-directory) "Directory for user's scratch files." :group 'user-directories :type 'string)
...
(defcustom user-config-files '("appearance" "key-bindings" "general" "user" "programming") "User configuration files.")
