...
(setq erc-server "irc.freenode.net" ;; default ERC server
      ...
      erc-autojoin-channels-alist '((".*\\.freenode.net" "#emacs" "#stumpwm" "#conkeror" "#lisp" "#guile" "#haskell" "#org-mode" "#ubuntu-offtopic" "#debian-offtopic" "#ubuntu-au" "##club-ubuntu" "##math" "##programming"))
