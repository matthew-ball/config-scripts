...
if [ -f ~/.conf-scripts/bash-dir/aliases.sh ]; then
    . ~/.conf-scripts/bash-dir/aliases.sh
fi

### COMMENT: bash functions (sourced from ~/.conf-scripts/bash-dir/functions.sh)
if [ -f ~/.conf-scripts/bash-dir/functions.sh ]; then
    . ~/.conf-scripts/bash-dir/functions.sh
fi
